  ...
  return (
    <div className="w-full rounded-2xl p-4 space-y-3" style={{ backgroundColor: C.card, border: `1px solid ${C.border}` }}>
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          <button onClick={undo} disabled={!hasUndo} className="p-2 rounded-lg transition-colors hover:bg-white/5 disabled:opacity-30" style={{ color: C.sub }} title="撤销"><Undo2 size={15} /></button>
          <button onClick={redo} disabled={!hasRedo} className="p-2 rounded-lg transition-colors hover:bg-white/5 disabled:opacity-30" style={{ color: C.sub }} title="重做"><Redo2 size={15} /></button>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_330px] gap-3">
        ...
        <div className="space-y-3 min-w-0">
          ...
          <div className="flex items-center justify-center gap-2 rounded-xl px-3 py-2" style={{ backgroundColor: C.input, border: `1px solid ${C.border}` }}>
            <button onClick={() => seekTo(0)} className="p-2 rounded-lg hover:bg-white/5 transition-colors" style={{ color: C.sub }} title="回到开头"><SkipBack size={14} /></button>
            <button onClick={() => seekTo(Math.max(0, playhead - 1))} className="p-2 rounded-lg hover:bg-white/5 transition-colors" style={{ color: C.sub }} title="后退 1 秒"><ChevronLeft size={14} /></button>
            ...
            <button onClick={() => seekTo(Math.min(total, playhead + 1))} className="p-2 rounded-lg hover:bg-white/5 transition-colors" style={{ color: C.sub }} title="前进 1 秒"><ChevronRight size={14} /></button>
            <button onClick={() => seekTo(total)} className="p-2 rounded-lg hover:bg-white/5 transition-colors" style={{ color: C.sub }} title="跳到结尾"><SkipForward size={14} /></button>
          ...
          {resultUrl && (
            <div className="rounded-xl overflow-hidden" style={{ backgroundColor: C.input, border: `1px solid ${C.border}` }}>
              ...
              <div className="flex items-center justify-between px-3 py-2">
                ...
                }} className="p-1.5 rounded-lg hover:bg-white/5 transition-colors" style={{ color: C.sub }} title="下载"><Download size={14} /></button>
              </div>
            </div>
          )}
        </div>
            ...
            <div className="space-y-2.5">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-1">
                  <button onClick={() => moveClip(-1)} className="p-1.5 rounded-lg hover:bg-white/5 transition-colors" style={{ color: C.sub }} title="前移"><ChevronLeft size={13} /></button>
                  <button onClick={() => moveClip(1)} className="p-1.5 rounded-lg hover:bg-white/5 transition-colors" style={{ color: C.sub }} title="后移"><ChevronRight size={13} /></button>
                  <button onClick={() => { setClips(prev => prev.filter(c => c.id !== selectedClip.id)); setSelectedClipId('') }} className="p-1.5 rounded-lg hover:bg-white/5 transition-colors" style={{ color: '#EF4444' }} title="删除"><Trash2 size={13} /></button>
                </div>
              </div>
          ...
          {selectedAudio && (
            <div className="space-y-2.5">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => { setAudioClips(prev => prev.filter(a => a.id !== selectedAudio.id)); setSelectedAudioId('') }} className="p-1.5 rounded-lg hover:bg-white/5 transition-colors" style={{ color: '#EF4444' }}><Trash2 size={13} /></button>
              </div>
