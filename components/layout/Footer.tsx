      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12 pt-20 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <h4 className="font-sans text-micro tracking-[0.28em] uppercase font-semibold mb-6" style={{ color: ACCENT }}>Collections</h4>
          ...
          <div className="lg:col-span-2">
            <h4 className="font-sans text-micro tracking-[0.28em] uppercase font-semibold mb-6" style={{ color: ACCENT }}>Company</h4>
            <ul className="space-y-3.5">
          ...
          <div className="lg:col-span-3">
            <h4 className="font-sans text-micro tracking-[0.28em] uppercase font-semibold mb-6" style={{ color: ACCENT }}>Contact</h4>
        ...
        <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12 py-16 md:py-20">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-10">
            ...
            <button
              ...
              className="group inline-flex items-center gap-2.5 self-start lg:self-end font-sans text-micro tracking-[0.28em] uppercase font-semibold px-5 py-3 transition-all duration-300 hover:-translate-y-0.5"
