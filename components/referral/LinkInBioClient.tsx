...
export default function LinkInBioClient({
  ...
  return (
    <div className="min-h-screen bg-[#FBFAF7] text-[#2A2118]">
      <section className="border-b border-[#E7E1D7] bg-[#FFFFFF]/70">
        <div className="mx-auto max-w-6xl px-6 py-4 sm:px-8 lg:px-12">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-[#D8CEBD] bg-[#FFFFFF] px-4 py-2 text-xs text-[#5A4A36]">
      ...
      <section className="mx-auto grid max-w-6xl grid-cols-1 gap-8 px-6 py-10 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:px-12 lg:py-14">
        <div className="space-y-6">
          <div className="rounded-[28px] border border-[#E7E1D7] bg-[#FFFFFF] p-6 shadow-sm md:p-8">
            ...
            <p className="mt-4 max-w-2xl font-sans text-sm leading-7 text-[#5A4A36] md:text-base">
              {heroBody}
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              {heroProduct && referralCode ? (
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-[#2A2118] px-6 py-3 text-xs font-medium uppercase tracking-[0.26em] text-white transition hover:bg-[#1A1A1A]"
                >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full border border-[#D8CEBD] px-6 py-3 text-xs font-medium uppercase tracking-[0.26em] text-[#2A2118] transition hover:border-[#8A6A2E]"
              >
          ...
          <div className="rounded-[28px] border border-[#E7E1D7] bg-[#FFFFFF] p-6 shadow-sm md:p-8">
            <div className="flex items-center gap-2">
              ...
              <p className="font-sans text-sm font-medium text-[#2A2118]">How this flow works</p>
            </div>
            <div className="mt-4 grid gap-3 md:grid-cols-3">
              {[
                ...
                <div key={item} className="rounded-2xl bg-[#FBFAF7] p-4 font-sans text-sm leading-6 text-[#5A4A36]">
                  {item}
                </div>
              ))}
            </div>
          ...
          {heroProduct && (
            <div className="overflow-hidden rounded-[28px] border border-[#E7E1D7] bg-[#FFFFFF] shadow-sm">
              ...
              <div className="p-6">
                ...
                <p className="mt-3 font-sans text-sm leading-6 text-[#5A4A36]">
                ...
                <Link
                  ...
                  className="mt-5 inline-flex items-center gap-2 text-xs font-medium uppercase tracking-[0.26em] text-[#2A2118] transition hover:text-[#8A6A2E]"
                >
              ...
              {featuredProducts.map((product) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="font-en text-lg font-medium text-[#2A2118]">
                      {product.nameEn || product.name}
                    </p>
                    <p className="mt-1 line-clamp-2 font-sans text-sm leading-6 text-[#5A4A36]">
