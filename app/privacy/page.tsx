  ...
  return (
    <div className="bg-[#F8F5F0] min-h-screen">
      <div className="max-w-3xl mx-auto px-6 sm:px-8 lg:px-12 py-12 md:py-16">
        <h1 className="font-en text-3xl md:text-4xl text-[#2C2C2C] font-semibold tracking-tight mb-2">Privacy Policy</h1>
        <p className="font-sans text-xs text-[#6B6B6B]/50 mb-8">Last updated: August 2026</p>

        <div className="space-y-6 font-sans text-sm leading-7 text-[#4A4A4A]">
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">3. Payment Information</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">4. Social Media Integration</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">5. Cookies</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">6. Data Retention & Your Rights</h2>
            <p>We retain order data as long as necessary for legal and business purposes. You may request access to, correction of, or deletion of your personal data by contacting us through the <a href="/contact" className="text-[#8B7D5C] hover:underline">Contact page</a>.</p>
          </section>

          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">7. Contact</h2>
            <p>For any privacy questions, please reach out via our <a href="/contact" className="text-[#8B7D5C] hover:underline">Contact page</a>.</p>
          </section>
        </div>
      </div>
    </div>
