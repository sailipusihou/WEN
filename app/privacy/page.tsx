  ...
  return (
    <div className="bg-[#FBFAF7] min-h-screen">
      <div className="max-w-3xl mx-auto px-6 sm:px-8 lg:px-12 py-12 md:py-16">
        <h1 className="font-en text-3xl md:text-4xl text-[#2A2118] font-medium tracking-[0.005em] mb-2">Privacy Policy</h1>
        <p className="font-sans text-xs text-[#5A4A36]/50 mb-8">Last updated: August 2026</p>

        <div className="space-y-6 font-sans text-sm leading-7 text-[#4A4A4A]">
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2A2118] mb-2">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2A2118] mb-2">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2A2118] mb-2">3. Payment Information</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2A2118] mb-2">4. Social Media Integration</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2A2118] mb-2">5. Cookies</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2A2118] mb-2">6. Data Retention & Your Rights</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2A2118] mb-2">7. Contact</h2>
