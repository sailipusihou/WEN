    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 bg-[#FBFAF7]">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="font-en text-3xl md:text-4xl text-ink font-medium tracking-[0.005em] mb-1">Create Account</h1>
          <p className="font-sans text-sm text-ink-soft/60">Join the Low Flame community</p>
        </div>
        <form onSubmit={handleSubmit} noValidate className="bg-[#FFFFFF]/80 border border-[#EFE7D4]/60 p-6 md:p-8 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-micro font-sans text-ink-soft/60 tracking-[0.18em] uppercase mb-1.5">First Name</label>
            ...
            <div>
              <label className="block text-micro font-sans text-ink-soft/60 tracking-[0.18em] uppercase mb-1.5">Last Name</label>
