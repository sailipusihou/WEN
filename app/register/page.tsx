    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 bg-[#FBFAF7]">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="font-en text-3xl md:text-4xl text-[#2A2118] font-medium tracking-[0.005em] mb-1">Create Account</h1>
          <p className="font-sans text-sm text-[#5A4A36]/60">Join the Low Flame community</p>
        </div>
