  ...
  return (
    <div className="bg-[#F8F5F0] min-h-screen">
      <div className="max-w-3xl mx-auto px-6 sm:px-8 lg:px-12 py-12 md:py-16">
        <h1 className="font-en text-3xl md:text-4xl text-[#2C2C2C] font-semibold tracking-tight mb-2">Terms of Service</h1>
        ...
        <div className="space-y-6 font-sans text-sm leading-7 text-[#4A4A4A]">
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">2. Products & Orders</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">3. Shipping & Returns</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">4. Reviews & User Content</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">5. Intellectual Property</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2C2C2C] mb-2">6. Limitation of Liability</h2>
          ...
          <section>
            ...
            <p>Questions about these Terms can be sent through our <a href="/contact" className="text-[#8B7D5C] hover:underline">Contact page</a>.</p>
          </section>
        </div>
      </div>
    </div>
