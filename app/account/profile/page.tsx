...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      {/* Avatar */}
      <div className="bg-white/70 border border-otb-sand/50 rounded-sm p-6 mb-6">
      ...
      {/* Profile Info */}
      <div className="bg-white/70 border border-otb-sand/50 rounded-sm p-6 space-y-4 mb-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div><label className="block text-xs font-sans text-otb-ink/60 mb-1.5">First Name</label>
            <input value={form.firstName} onChange={e => update("firstName", e.target.value)} className="w-full px-3 py-2.5 border border-otb-sand/50 rounded-sm bg-white text-sm font-sans focus:outline-none focus:border-otb-terracotta/50" /></div>
          <div><label className="block text-xs font-sans text-otb-ink/60 mb-1.5">Last Name</label>
            <input value={form.lastName} onChange={e => update("lastName", e.target.value)} className="w-full px-3 py-2.5 border border-otb-sand/50 rounded-sm bg-white text-sm font-sans focus:outline-none focus:border-otb-terracotta/50" /></div>
        </div>
        <div><label className="block text-xs font-sans text-otb-ink/60 mb-1.5">Phone</label>
          <input value={form.phone} onChange={e => update("phone", e.target.value)} className="w-full px-3 py-2.5 border border-otb-sand/50 rounded-sm bg-white text-sm font-sans focus:outline-none focus:border-otb-terracotta/50" /></div>
        <div className="grid grid-cols-2 gap-3">
          <div><label className="block text-xs font-sans text-otb-ink/60 mb-1.5">Date of Birth</label>
            <input type="date" value={form.dob} onChange={e => update("dob", e.target.value)} className="w-full px-3 py-2.5 border border-otb-sand/50 rounded-sm bg-white text-sm font-sans focus:outline-none focus:border-otb-terracotta/50" /></div>
          <div><label className="block text-xs font-sans text-otb-ink/60 mb-1.5">Gender</label>
            <select value={form.gender} onChange={e => update("gender", e.target.value)} className="w-full px-3 py-2.5 border border-otb-sand/50 rounded-sm bg-white text-sm font-sans focus:outline-none focus:border-otb-terracotta/50">
      ...
      {/* Change Password */}
      <div className="bg-white/70 border border-otb-sand/50 rounded-sm p-6 space-y-4">
        ...
        <div><label className="block text-xs font-sans text-otb-ink/60 mb-1.5">Current Password</label>
          <input type="password" value={pwForm.current} onChange={e => pwUpdate("current", e.target.value)} className="w-full px-3 py-2.5 border border-otb-sand/50 rounded-sm bg-white text-sm font-sans focus:outline-none focus:border-otb-terracotta/50" /></div>
        <div className="grid grid-cols-2 gap-3">
          <div><label className="block text-xs font-sans text-otb-ink/60 mb-1.5">New Password</label>
            <div className="relative"><input type={showPw ? "text" : "password"} value={pwForm.newPw} onChange={e => pwUpdate("newPw", e.target.value)} minLength={6}
              className="w-full px-3 py-2.5 pr-10 border border-otb-sand/50 rounded-sm bg-white text-sm font-sans focus:outline-none focus:border-otb-terracotta/50" />
