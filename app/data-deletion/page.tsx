  ...
  return (
    <div className="bg-[#FBFAF7] min-h-screen">
      <div className="max-w-3xl mx-auto px-6 sm:px-8 lg:px-12 py-12 md:py-16">
        <h1 className="font-en text-3xl md:text-4xl text-[#2A2118] font-medium tracking-[0.005em] mb-2">User Data Deletion</h1>
        ...
        <div className="space-y-6 font-sans text-sm leading-7 text-[#4A4A4A]">
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2A2118] mb-2">1. Your Right to Deletion</h2>
            <p>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2A2118] mb-2">2. How to Request Deletion</h2>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2A2118] mb-2">3. What Happens Next</h2>
            <p>
          ...
          <section>
            <h2 className="font-en text-lg font-semibold text-[#2A2118] mb-2">4. Contact</h2>
            <p>
